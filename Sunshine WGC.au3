...
#AutoIt3Wrapper_Res_Description=Sunshine WGC
...
if _Singleton("Sunshine WGC")= 0 Then
	exit
	endif

AutoItSetOption("TrayIconDebug", 1)
;Opt("TrayMenuMode", 1) ; Modalità evento


if ProcessExists("Sunshine DDX.exe") Then
	processclose("Sunshine DDX.exe")
endif
